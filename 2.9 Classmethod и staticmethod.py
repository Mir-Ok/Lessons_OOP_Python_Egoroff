...
''' Суть проблемы:
    ...
    Плюс она просто лежит внутри класса, без self и не относится по умолчанию к вновь созданным экземплярам,
    плюс ей можно задать прием любого другого аргумента по необходимости, с именем НЕ self
